                ...
                <div id="m_nav_container" class="m_nav wthree_bg">
                    <nav class="menu menu--sebastian">
                        <ul id="m_nav_list" class="m_nav menu__list">
                           ...
                           <li class="m_nav_item" id="moble_nav_item_2"> <a href="/site/about" class="link link--kumya scroll"><i class="fa fa-cog" aria-hidden="true"></i><span data-letters="О проекте">О проекте</span></a></li>
                           <li class="m_nav_item" id="moble_nav_item_3"> <a href="/site/about" class="link link--kumya scroll"><i class="fa fa-info-circle" aria-hidden="true"></i><span data-letters="Контакты">Контакты</span></a></li>
                           <li class="m_nav_item" id="moble_nav_item_5"> <a href="/site/gallery" class="link link--kumya scroll"><i class="fa fa-picture-o" aria-hidden="true"></i><span data-letters="Вход">Вход&nbsp;</span></a></li>
                           <li class="m_nav_item" id="moble_nav_item_6"> <a href="/site/contact" class="link link--kumya scroll"><i class="fa fa-envelope-o" aria-hidden="true"></i><span data-letters="Регистрация">Регистрация</span></a></li>
                       </ul>
                   </nav>
               </div>
           </div>
